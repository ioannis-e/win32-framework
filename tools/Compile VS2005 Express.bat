...
vcbuild /rebuild MDIDockFrame\ProjectFiles\MDIDockFrame_2005.vcproj debug           >>"..\output\VS2005.log"
vcbuild /rebuild MDIDockFrame\ProjectFiles\MDIDockFrame_2005.vcproj release         >>"..\output\VS2005.log"
